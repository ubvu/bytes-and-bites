---
title: "Article - LLMs in research: A round up of services"
draft: false
date: "09/04/2025"
description: "A round up of the available services"
categories: [LLMs, EU alternatives, solutions, tools]
image: "../mediabag/images/2025/robot_thumbnail.png"
---

![_Credit https://pngimg.com_](../mediabag/images/2025/robot.png){height=300}
...
with LLM use; over-reliance and brain atrophy ([Kosmyna et al.](https://arxiv.org/abs/2506.08872)), environmental impact ([environmental impact](https://news.mit.edu/2025/explained-generative-ai-environmental-impact-0117), 
[emissions](https://e360.yale.edu/features/artificial-intelligence-climate-energy-emissions), [water theft](https://www.bbc.com/news/articles/cy8gy7lv448o), [energy usage estimates](https://tilburg.ai/2024/09/llms-environmental-impact/)), 
security issues  and privacy concerns([survey of LLM security and privacy](https://www.sciencedirect.com/science/article/pii/S266729522400014X), [report on LLM privacy risks and functionality](https://www.edpb.europa.eu/system/files/2025-04/ai-privacy-risks-and-mitigations-in-)), 
ignoring of copyrights ([summary of copyright cases against OpenAI](https://originality.ai/blog/openai-chatgpt-lawsuit-list)), and the fact they will often just lie. 
However, they are useful tools when used responsibly. 

<br/><br/>

> "_A responsible alternative to existing LLMs_" 
>
> -- GPT-NL
...
Yet closer to home and we find [GPT-NL](https://gpt-nl.nl/), a Dutch language & ethically trained model. Touting themselves as "A responsible alternative to existing LLMs" they claim that all data 
used in the training has been lawfully obtained putting the copyright concern to bed for this particular model. It also provides insight into why certain decisions were made regarding data and the 
...
LLMs have a lot of issues, from environmental to potential brain atrophy of users, but there are far more models than what silicon valley has to offer. From [Jan](https://jan.ai/) for running models locally and to 
[Nebula](https://networkinstitute.org/nebula/) at the VU serving various open source LLMs at from the [Network Institute](https://networkinstitute.org/).
