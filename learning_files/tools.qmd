...
[FAIR code template](https://ss-nes.github.io/meta-template/python-case.html) - TU Delft has crafted a python project template for making writing FAIR software in the NES domain that much easier. 
...
[code-auditor](https://github.com/SS-NES/code-auditor/tree/v0.2.1) - A package and command-line utility to audit code quality and compliance to the best practices. 

[autoMETAte](https://github.com/ubvu/autoMETAte) - A pre-commit hook that will create and update a metadata file for your software every time you make a commit to always be up to date.

[metacheck](https://github.com/scienceverse/metacheck) - An automated best practice check for research papers written in R with options to run locally or on Dutch cloud services.


### IDEs and Workspaces

[VSCodium](https://vscodium.com/) - 
Use the versatility of the VS Code without the tracking of Microsoft!
...
[RSpace](https://www.researchspace.com/) - a digital lab space where you can connect all the services and software you use in your project in one location to help keep a FAIR workflow.

[Notebook.link](https://notebook.link/) - A place to run notebooks in your browser, there is even the possibility to [run C++ in a notebook](https://notebook.link/@quantstack/xeus-cpp).

[Marimo](https://marimo.io/) - An open source Python notebook workspace that saves the code as ".py" that is shareable as an app with built in SQL and LLM features. Share your work in an interactive way. 
...
[Ersilia](https://www.ersilia.io/tools) has a CLI (command line interface) download that allows you to download and directly use any of their open source ML models for Chemistry straight out of the box. 


### Data Visualisation

[Apache Superset](https://superset.apache.org/) -  an open-source modern data exploration and visualization platform. Think open source PowerBI and kick Microsoft to the curb!

[VisQuill](https://visquill.com/visquill) - Build unique and interactive visuals to explain or explore your data!
...
[OSMnx](https://osmnx.readthedocs.io/en/stable/) - a Python package to easily download, model, analyze, and visualize street networks and other geospatial features from OpenStreetMap. You can download and model walking, driving, or biking networks with a single line of code then analyze and visualize them.

[xkcdpass](https://github.com/redacted/XKCD-password-generator) - a way to create secure, but easy to remember passwords. For those familiar with xkcd this comes from [comic 936](https://xkcd.com/936/). For those unfamiliar the concept the idea is that modern password requirements are usually quite easily broken with bruteforce and a few rules applied, but difficult for humans to remember. Writing a sentence or stringing together 3-4 words is easy for a human to remember, but difficult to hack.

[drawdata](https://pypi.org/project/drawdata/) - Have you ever needed a toy dataset to test some code or try out a model? Finding data that has the right sort of shape can be difficult, but with drawdata you can draw a data set with Jupyter, VSCode and Colab. 

[passagemath](https://passagemath.org/) - a general purpose mathematical software system. The passagemath fork uses the motto "Creating a Free Passage Between the Scientific Python Ecosystem and Mathematical Software Communities."


### Useful R Libraries

[testthat](https://testthat.r-lib.org/) is an R library created with the intention to make writing tests for your code fun and easy. It is on CRAN, so download and installation is straightforward.

[mori](https://cran.r-universe.dev/mori) is a library for more memory efficient parallel programming in R. It refers each CPU to the same shared objects instead of making a copy for each.


### HPC (super computers)

[JupyterDaskOnSlurm Template](https://github.com/RS-DAT/JDS_development_template)

[CernVM](https://cvmfs.readthedocs.io/en/stable/cpt-overview.html) is a way to produce standardised virtual machines for use on super computers meaning all researchers can work in the same environment and better co-develop and share tools, scripts, and software.
