...
If you are looking for additional sessions to Bytes & Bites you can perhaps find support in the [codebar](https://codebar.io/) sessions though do note that as a student “_workshops and events are exclusively for women, non-binary, LGBTQ+ members (mirrored also in the [rainborR](https://rainbowr.org/) buddy programme), and people from underrepresented minority groups_”. They do however upload their talks to [their youtube channel](https://www.youtube.com/@codebarhq/videos), much like [PyData](https://www.youtube.com/user/PyDataTV) (talks mostly on data analysis in various languages). If you are interested in webdevelopment with Python then you might be interested in [Django Girls](https://djangogirls.org/en/amsterdam/) that regularly host **free** Python and Django workshops around the world for women to join.
...
The UB regularly hosts a **free** coding course for beginners based on the Carpentry workshops, so search for Software Carpentry in the [events page of the VU Amsterdam](https://vu.nl/nl/agenda) or directly in [libcal](https://libcal.vu.nl/calendar/universitylibrary)! There are intermediate courses for both R and Python in development that will hopefully begin in 2027.
...
![Good practice for cable management, credit https://blog.michaelfmcnamara.com](../images/cable_management.jpg){width=200}


Learning how to code is the start of the journey, but as the size of your projects grow the most important factor quickly becomes adhering to good practice standards. Get ahead and start learning now!

[Framework for Open and Reproducible Research Training](https://forrt.org/curated_resources/): Known as FORRT the intention is to provide infrastructure and learning resources for the teaching and learning of open and reproducible science which extends to software.

[The Missing Semester of Your CS Education](https://missing.csail.mit.edu/) is exactly what it says, a guide to all the parts of programming that is not explicitly taught in courses. Written in 18 different languages it covers code quality and standard, version control with Git, and packing and shipping code.

[Practical guide to Software Management Plans](https://zenodo.org/records/7589725): A short guide to the benefits of making a software management plan with links to learn more and examples where and how to use one.

[Introducing Computational Thinking](https://librarycarpentry.github.io/lc-computational-thinking/intro.html) is a work in progress course to teach people how to get the right mindset for thinking like a computer and writing effective code.

[fair-software.nl](https://fair-software.nl/) is a great place to get your intro to the five key points to write Findable, Accessible, Interoperable, and Re-usable software. For a more indepth and institution specific information check out the FAIR software page in the [VU RDM handbook](https://rdm.vu.nl/guides/publishing-fair-software.html). 

[Code for Thought](https://codeforthought.buzzsprout.com/): A podcast series interviewing developers and researchers both providing tips on good practice and information on initiatives and tools. The podcast has episodes in German, French, and English. 

[Intermediate programming from UU](https://centrefordigitalhumanities.github.io/research-software-summer-school/) - The University of Utrecht has piloted a new course for intermediate programming in research. It covers fundamental topics that are considered to be beyond beginner level. Take a look if you feel it's time to move past the beginner stage!
...
[The Hitchhiker’s Guide to Python](https://docs.python-guide.org/) is truly a one stop shop for learning how to develop in Python, from virtual environments to code style, testing to scraping, publishing to project structure all in 7 different languages. Reitz and Schlusser have covered almost everything you could every want to know when it comes to good practice in Python.
...
[R for Graduate Students](https://bookdown.org/yih_huynh/Guide-to-R-Book/index.html) is a guide written by a PhD student (Wendy Huynh) for PhD students.
...
[Statistical analysis and presentation using R](https://poweleiden.github.io/statistics1/) covers the use of R for an introductory statistics course from the Institute of Political Science in Leiden. They also have a great resource for [debugging in R](https://poweleiden.github.io/statistics1/common_errors.html) showing some of the most common errors and how to fix them.
